...
deploy-sepolia:
	@forge script script/DeployLottery.s.sol:DeployLottery --rpc-url $(SEPOLIA_RPC_URL) --account myaccount --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
